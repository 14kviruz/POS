...
class ModeloCliente
{
  ...
  static public function mdlRegCliente($data)
  {
    ...
    cliente(razon_social_cliente, nit_ci_cliente, direccion_cliente, 
    nombre_cliente, telefono_cliente, email_cliente) 
    values('$razon_social_cliente', '$nit_ci_cliente', '$direccion_cliente',
     '$nombre_cliente', '$telefono_cliente', '$email_cliente')");
    if ($stmt->execute()) {
      return "ok";
    } else {
  ...
  static public function mdlEditcliente($data)
  {
    ...
    razon_social_cliente='$razon_social_cliente', nit_ci_cliente='$nit_ci_cliente', 
    direccion_cliente='$direccion_cliente', nombre_cliente='$nombre_cliente', 
